...
public class GenerateCode {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        strategy.setTablePrefix(new String[] { "crim" });// 此处可以修改为您的表前缀
        strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略 t_user_xxx UserXxx

        strategy.setEntityLombokModel(true);
        // strategy.setRestControllerStyle(true);
        strategy.setSuperEntityClass("com.heycm.model.base.BaseModel");
        strategy.setSuperEntityColumns("create_user", "create_time", "modify_user", "modify_time", "is_deleted");

        String[] tables = rb.getString("tables").split(",");
        strategy.setInclude(tables); //配置要生成代码的表
        strategy.setLogicDeleteFieldName("is_deleted");//配置逻辑删除的列
        ...
        focList.add(new FileOutConfig("/templates/entity.java.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                return rb.getString("OutputDirBase")+ "/com/heycm/model/" + tableInfo.getEntityName() + ".java";
            }
        });
        ...
        focList.add(new FileOutConfig("/templates/controller.java.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return rb.getString("OutputDir")+ "/com/heycm/controller/" + tableInfo.getEntityName() + "Controller.java";
            }
        });
