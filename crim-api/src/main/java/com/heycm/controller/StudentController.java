...
public class StudentController {
     ...
     */
    @PostMapping("/save")
    public ResponseMessage save(@RequestBody Param<Student> param) {
        if (param == null) {
            return Result.error("1000", "参数为NUll");
        }
            studentService.saveOrUpdate(param.getData());
        return Result.ok();
    }
    ...
    */
    ...
    public ResponseMessage pageList(@RequestBody Param<StudentQuery> param) {
        ...
        Page<Student> page = new Page<Student>(param.getPage(), param.getRows());
        IPage iPage = studentService.page(page, null);
